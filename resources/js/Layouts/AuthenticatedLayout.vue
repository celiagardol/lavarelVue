            ...
            <nav class="bg-white border-b border-gray-100">
                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('subcategorias.index')" :active="route().current('sucategorias.index')">
                            Subcategorias
                        </ResponsiveNavLink>
                        <ResponsiveNavLink :href="route('graficos')" :active="route().current('graficos')">
                            Graficos
                        </ResponsiveNavLink>
